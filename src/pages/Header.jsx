...
const Header = () => {
  ...
  return (
    <header
      className="w-full fixed top-0 left-0 flex items-center justify-between px-10 py-5 bg-transparent z-50"
      data-aos="fade-down"
    >
      ...
      <nav
        className="hidden md:flex mt-5 space-x-8 backdrop-blur border border-gray-30/20 bg-black/70 bg-white/10 px-8 py-3 rounded-full"
        data-aos="fade-down"
        data-aos-delay="200"
      >
      ...
      <div className="flex items-center space-x-5" data-aos="fade-left" data-aos-delay="300">
        {!user ? (
          <button
            onClick={openSignIn}
            className="bg-[#f84565] hover:bg-[#e43e5e] rounded-full py-2 px-5 text-white font-medium hidden md:block"
          >
            Login
          </button>
        ) : (
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <button
            onClick={openSignIn}
            className="bg-[#f84565] hover:bg-[#e43e5e] rounded-full py-2 px-6 text-white font-medium"
          >
            Login
          </button>
        </div>
